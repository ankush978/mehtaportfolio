...
const Button56Props = useStore((state)=>state["view_project"]["Button56"]);
const Button56IoProps = useIoStore((state)=>state["view_project"]["Button56"]);
const Button56Cb = useButton56Cb()
const Button57Props = useStore((state)=>state["view_project"]["Button57"]);
const Button57IoProps = useIoStore((state)=>state["view_project"]["Button57"]);
const Button57Cb = useButton57Cb()
const Button58Props = useStore((state)=>state["view_project"]["Button58"]);
const Button58IoProps = useIoStore((state)=>state["view_project"]["Button58"]);
const Button58Cb = useButton58Cb()
const TextBox263Props = useStore((state)=>state["view_project"]["TextBox263"]);
const TextBox263IoProps = useIoStore((state)=>state["view_project"]["TextBox263"]);
const TextBox263Cb = useTextBox263Cb()
const TextBox265Props = useStore((state)=>state["view_project"]["TextBox265"]);
const TextBox265IoProps = useIoStore((state)=>state["view_project"]["TextBox265"]);
const TextBox265Cb = useTextBox265Cb()
const Button59Props = useStore((state)=>state["view_project"]["Button59"]);
const Button59IoProps = useIoStore((state)=>state["view_project"]["Button59"]);
const Button59Cb = useButton59Cb()
const Button60Props = useStore((state)=>state["view_project"]["Button60"]);
const Button60IoProps = useIoStore((state)=>state["view_project"]["Button60"]);
const Button60Cb = useButton60Cb()
const Button61Props = useStore((state)=>state["view_project"]["Button61"]);
const Button61IoProps = useIoStore((state)=>state["view_project"]["Button61"]);
const Button61Cb = useButton61Cb()
const TextBox267Props = useStore((state)=>state["view_project"]["TextBox267"]);
const TextBox267IoProps = useIoStore((state)=>state["view_project"]["TextBox267"]);
const TextBox267Cb = useTextBox267Cb()
const Button62Props = useStore((state)=>state["view_project"]["Button62"]);
const Button62IoProps = useIoStore((state)=>state["view_project"]["Button62"]);
const Button62Cb = useButton62Cb()
const Button63Props = useStore((state)=>state["view_project"]["Button63"]);
const Button63IoProps = useIoStore((state)=>state["view_project"]["Button63"]);
const Button63Cb = useButton63Cb()
const Button64Props = useStore((state)=>state["view_project"]["Button64"]);
const Button64IoProps = useIoStore((state)=>state["view_project"]["Button64"]);
